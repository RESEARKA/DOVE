// Bypass timelock and launch DOVE token on Base Sepolia testnet
// Usage: npx hardhat run scripts/admin/bypass-timelock.js --network baseSepolia
...
async function main() {
  ...
  try {
    console.log("\n=== STEP 1: Schedule Launch Operation ===");
    console.log("Calling launch() first time to schedule...");
    const scheduleTx = await admin.launch();
    await scheduleTx.wait();
    console.log("Launch operation scheduled successfully!");
    
    console.log("\n=== STEP 2: Bypass Timelock ===");
    ...
    console.log("\n=== STEP 3: Execute Launch Operation ===");
    console.log("Calling launch() second time to execute...");
