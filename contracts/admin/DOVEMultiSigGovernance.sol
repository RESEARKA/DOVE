...
import "./DOVEAdminBase.sol";

/**
 * @title DOVE Multi-Signature Governance
 * @dev Implements multi-signature approval functionality for critical operations
 */
abstract contract DOVEMultiSigGovernance is DOVEAdminBase {
    // ================ Events ================
     ...
     */
    function approveOperation(bytes32 operation) external onlyRole(DEFAULT_ADMIN_ROLE) {
